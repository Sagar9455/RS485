        ...
        while True:
            if GPIO.input(BUTTON_PIN) == GPIO.LOW:
                ...
                try:
                    ...
                    status = "Fail"
                report_data.append({"timestamp": timestamp, "description": "Default Session (0x10 0x01)", "status": status})
                time.sleep(0.5)
                ...
                try:
                    ...
                    status = "Fail"
                report_data.append({"timestamp": timestamp, "description": "Extended Session (0x10 0x03)", "status": status})
                time.sleep(0.5)
                ...
                try:
                    ...
                    print(f"Error: {e}")
                    status = "Fail"
                report_data.append({"timestamp": timestamp, "description": "Read DID (22 F1 00)", "status": status})
